...
=======
  ...
  test "should create basket_item" do
    assert_difference('BasketItem.count') do
      post :create, basket_item: { basket_id: @basket_item.basket_id, item_id: @basket_item.item_id, quantity: @basket_item.quantity }
    end
  ...
  test "should update basket_item" do
    patch :update, id: @basket_item, basket_item: { basket_id: @basket_item.basket_id, item_id: @basket_item.item_id, quantity: @basket_item.quantity }
    assert_redirected_to basket_item_path(assigns(:basket_item))
  end
